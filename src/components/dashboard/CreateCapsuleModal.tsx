  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-dark-800/90 backdrop-blur-xl rounded-xl w-full max-w-2xl overflow-hidden border border-neon-blue/20 shadow-neon-glow"
        ...
        <div className="p-6 border-b border-dark-600 flex justify-between items-center relative">
          ...
          <div>
            <motion.h2 
              ...
              className="text-2xl font-cyber font-bold bg-gradient-to-r from-neon-blue via-neon-purple to-neon-pink bg-clip-text text-transparent"
            >
              Create Time Capsule
            </motion.h2>
            <motion.p
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={onClose}
            className="p-2 hover:bg-dark-700 rounded-lg transition-all duration-300 text-dark-200 hover:text-neon-blue"
          >
