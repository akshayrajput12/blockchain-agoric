  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8 bg-gray-800 p-6 rounded-lg">
        <h2 className="text-2xl font-bold mb-4 text-white">Create New Credential</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white font-mono"
              rows={4}
              placeholder="{}"
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300">Expiry Date (Optional)</label>
            <input
              type="datetime-local"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {credentials.map((credential) => (
          <div key={credential.id} className="bg-gray-800 rounded-lg p-6 space-y-4">
            ...
            <h3 className="text-xl font-bold text-white">{credential.title}</h3>
